            ...
            <div class="row">
                <div class="col-12 col-xl-12">
                    ...
                    <div class="card card-body border-0 shadow mb-4">
                        <h1 class="h5 mb-3" style="text-align: center"><b>Personal Information</b></h1>
                        ...
                        <form method="POST" action="{{ route('personalinfo.update', $personalinfo->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="first_name" name="first_name"
                                            ...
                                            placeholder="First Name" value="{{ $personalinfo->first_name }}">
                                        @error('first_name')
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="middle_name" name="middle_name"
                                            ...
                                            placeholder="Middle Name" value="{{ $personalinfo->middle_name }}">
                                        @error('middle_name')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="surname" name="surname"
                                            ...
                                            placeholder="Surname" value="{{ $personalinfo->surname }}">
                                        @error('surname')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="extension" name="extension"
                                            ...
                                            placeholder="Name Extension" value="{{ $personalinfo->extension }}">
                                        @error('extension')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="birthplace" name="birthplace"
                                            ...
                                            placeholder="Place of Birth" value="{{ $personalinfo->birthplace }}">
                                        @error('birthplace')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-2"><label for="sex">Sex
                                        ...
                                        <option value="Male" @if($personalinfo->sex == "Male") selected @endif>Male
                                        </option>
                                        <option value="Female" @if($personalinfo->sex == "Female") selected
                                            @endif>Female</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <select class="form-select mb-0" id="civil_status"
                                        aria-label="civil_status select example" name="civil_status">
                                        {{-- <option selected="selected">Sex</option> --}}
                                        <option value="Single" @if($personalinfo->civil_status == "Single") selected
                                            @endif>Single</option>
                                        <option value="Married" @if($personalinfo->civil_status == "Married") selected
                                            @endif>Married</option>
                                        <option value="Widowed" @if($personalinfo->civil_status == "Widowed") selected
                                            @endif>Widowed</option>
                                        <option value="Separated" @if($personalinfo->civil_status == "Separated")
                                            selected @endif>Separated</option>
                                        <option value="Others" @if($personalinfo->civil_status == "Others") selected
                                            @endif>Others</option>
                                    </select>
                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div id="other_civil_status" style="display: none;">
                                            <input type="text" id="other_civil_status" name="other_civil_status"
                                                ...
                                                value="{{ $personalinfo->other_civil_status }}">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="height" name="height"
                                            ...
                                            placeholder="Height (cm)" value="{{ $personalinfo->height }}">
                                        @error('height')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="weight" name="weight"
                                            ...
                                            placeholder="Weight (kg)" value="{{ $personalinfo->weight }}">
                                        @error('weight')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="form-select mb-0" id="blood_type"
                                        ...
                                        {{-- <option selected="selected">Sex</option> --}}
                                        <option value="unknown" @if($personalinfo->blood_type == "unknown") selected
                                            @endif>Unknown</option>
                                        <option value="a+" @if($personalinfo->blood_type == "a+") selected @endif>A+
                                        </option>
                                        <option value="a-" @if($personalinfo->blood_type == "a-") selected @endif>A-
                                        </option>
                                        <option value="b+" @if($personalinfo->blood_type == "b+") selected @endif>B+
                                        </option>
                                        <option value="b-" @if($personalinfo->blood_type == "b-") selected @endif>B-
                                        </option>
                                        <option value="ab+" @if($personalinfo->blood_type == "ab+") selected @endif>AB+
                                        </option>
                                        <option value="ab-" @if($personalinfo->blood_type == "ab-") selected @endif>AB-
                                        </option>
                                        <option value="o+" @if($personalinfo->blood_type == "o+") selected @endif>O+
                                        </option>
                                        <option value="o-" @if($personalinfo->blood_type == "o-") selected @endif>O-
                                        </option>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="gsis_id" name="gsis_id"
                                            ...
                                            placeholder="GSIS ID No." value="{{ $personalinfo->gsis_id }}">
                                        @error('gsis_id')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="pagibig_id" name="pagibig_id"
                                            ...
                                            placeholder="PAGIBIG ID No." value="{{ $personalinfo->pagibig_id }}">
                                        @error('pagibig_id')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="philhealth_id" name="philhealth_id"
                                            ...
                                            placeholder="PHILHEALTH ID No." value="{{ $personalinfo->philhealth_id }}">
                                        @error('philhealth_id')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="sss_id" name="sss_id"
                                            ...
                                            placeholder="SSS No." value="{{ $personalinfo->sss_id }}">
                                        @error('sss_id')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="agency_id" name="agency_id"
                                            ...
                                            placeholder="AGENCY EMPLOYEE No." value="{{ $personalinfo->agency_id }}">
                                        @error('agency_id')
                                        <x-input-error message="{{ $message }}" />
                                        @enderror
                                    </div>
                                            ...
                                            <div class="col-sm-4" id="FilipinoCheckbox">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="Filipino"
                                                        ...
                                                        @if($personalinfo->citizenship1 == 'Filipino') checked @endif
                                                    @error('filipinoCheckbox') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="By Birth"
                                                    ...
                                                    @if($personalinfo->citizenship2 == 'By Birth') checked @endif>
                                                <label class="form-check-label" for="defaultCheck10">
                                                    By Birth
                                                </label>
                                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-floating mb-3">
                                <input type="text" id="res_house" name="res_house"
                                    ...
                                    placeholder="House/Block/Lot No." value="{{ $personalinfo->res_house }}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-floating mb-3">
                                <input type="text" id="res_subdivision" name="res_subdivision"
                                    ...
                                    placeholder="Subdivision/Village" value="{{ $personalinfo->res_subdivision }}">
                        ...
                        <div class="col-sm-3">
                            <div class="form-floating mb-3">
                                <input type="text" id="res_barangay" name="res_barangay"
                                    ...
                                    placeholder="Barangay" value="{{ $personalinfo->res_barangay }}">
                        ...
                        <div class="col-sm-3">
                            <div class="form-floating mb-3">
                                <input type="text" id="res_municipality" name="res_municipality"
                                    ...
                                    placeholder="City/Municipality" value="{{ $personalinfo->res_municipality }}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-floating mb-3">
                                <input type="text" id="res_province" name="res_province"
                                    ...
                                    placeholder="Province" value="{{ $personalinfo->res_province }}">
                        ...
                        <div class="col-sm-2">
                            <div class="form-floating mb-3">
                                <input type="text" id="res_zipcode" name="res_zipcode"
                                    ...
                                    placeholder="Zip Code" value="{{ $personalinfo->res_zipcode }}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-floating mb-3">
                            <input type="text" id="per_house" name="per_house"
                                ...
                                placeholder="House/Block/Lot No." value="{{ $personalinfo->per_house }}">
                            <label for="floatingInput">House/Block/Lot No.</label>
                            @error('per_house')
                            <x-input-error message="{{ $message }}" />
                            @enderror
                    ...
                    <div class="col-sm-4">
                        <div class="form-floating mb-3">
                            <input type="text" id="per_subdivision" name="per_subdivision"
                                ...
                                placeholder="Subdivision/Village" value="{{ $personalinfo->per_subdivision }}">
                            <label for="floatingInput">Subdivision/Village</label>
                    ...
                    <div class="col-sm-3">
                        <div class="form-floating mb-3">
                            <input type="text" id="per_barangay" name="per_barangay"
                                ...
                                value="{{ $personalinfo->per_barangay }}">
                            <label for="floatingInput">Barangay</label>
                            @error('per_barangay')
                            <x-input-error message="{{ $message }}" />
                            @enderror
                    ...
                    <div class="col-sm-3">
                        <div class="form-floating mb-3">
                            <input type="text" id="per_municipality" name="per_municipality"
                                ...
                                placeholder="City/Municipality" value="{{ $personalinfo->per_municipality }}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-floating mb-3">
                            <input type="text" id="per_province" name="per_province"
                                ...
                                value="{{ $personalinfo->per_province }}">
                            <label for="floatingInput">Province</label>
                            @error('per_province')
                            <x-input-error message="{{ $message }}" />
                            @enderror
                    ...
                    <div class="col-sm-2">
                        <div class="form-floating mb-3">
                            <input type="text" id="per_zipcode" name="per_zipcode"
                                ...
                                value="{{ $personalinfo->per_zipcode }}">
                            <label for="floatingInput">Zip Code</label>
                ...
                <div class="mt-3">
                    <button class="btn btn-gray-800 mt-2 animate-up-2" type="submit"><i class="me-2 bi bi-save"></i>
                        Update</button>
                    <a href="{{ route('personalinfo.index') }}" class="btn btn-gray-800 mt-2 animate-up-2"><i
