<x-app-layout>
    ...
    <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group"><span class="input-group-text"><svg
                                                ...
                                                placeholder="dd/mm/yyyy" required="" name="birthday"></div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
        ...
        <div class="tab-pane fade show active" id="tabs-family-background" role="tabpanel"
            aria-labelledby="nav-profile-tab">
            ...skdfksdnfklndlfn,,lytryyteretrwtrerettddrd dtftertwts edye7e erye7fn</div>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="row" id="checkboxes">
                                                    <div class="col-sm-4" id="FilipinoCheckbox">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="Filipino" id="filipinoCheckbox"
                                                                name="citizenship1" @error('filipinoCheckbox')
                                                                is-invalid @enderror">
                                                            @error('filipinoCheckbox')
                                                            <x-input-error message="{{ $message }}" />
                                                            @enderror
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="form-check" id="DualCitizenshipCheckbox">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="Dual Citizenship" id="DualCitizenshipCheckbox"
                                                                name="citizenship1" @error('DualCitizenshipCheckbox')
                                                                is-invalid @enderror">
                                                            @error('DualCitizenshipCheckbox')
                                                            <x-input-error message="{{ $message }}" />
                                                            @enderror
