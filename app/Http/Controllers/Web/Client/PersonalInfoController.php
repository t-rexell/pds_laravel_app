...
class PersonalInfoController extends Controller
{
    public function store(StorePersonalInfoRequest $request)
    {
        ...
        Alert::toast('Personal Information Successfully Added', 'success');
    ...
    public function update(UpdatePersonalInfoRequest $request, ProfileInformation $personalinfo)
    {
		...
		Alert::toast('Personal Information Successfully Updated', 'success');

        return redirect()->route('personalinfo.index');
    }

    public function edit(ProfileInformation $personalinfo)
    {
        return view('personalinfo.edit', compact('personalinfo'));
    }

    public function destroy(Request $request, ProfileInformation $personalinfo)
    {
        if ( $request->ajax() ) {
